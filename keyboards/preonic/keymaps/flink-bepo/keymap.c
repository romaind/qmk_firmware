 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Meta |   À  |   Y  |   X  |   .  |   K  |   '  |   Q  |   G  |   H  |   F  |  Ç   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Enter| Lower| Ctrl | Alt  |Shift |    Space    |AltGr | Raise|   %  |   W  | Bksp |
 * `-----------------------------------------------------------------------------------'
 */
[_BEPO] = {
  ...
  {KC_LGUI, BP_AGRV, BP_Y,    BP_X,    BP_DOT,  BP_K,    BP_APOS, BP_Q,    BP_G,    BP_H,    BP_F,    BP_CCED},
  {KC_ENT,  LOWER,   KC_LCTL, KC_LALT, KC_LSFT, KC_SPC,  KC_SPC,  BP_ALGR, RAISE,   BP_PERC, BP_W,    KC_BSPC}
},
