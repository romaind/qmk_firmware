...
qk_tap_dance_action_t tap_dance_actions[] = {
  [MA] = ACTION_TAP_DANCE_DOUBLE(KC_LGUI, KC_LALT),
};
...
[_LOWER] = {
  ...
  {_______, _______, BP_LPRN, BP_RPRN, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_PAST, _______},
  {_______, _______, BP_LBRC, BP_RBRC, BP_LESS, BP_GRTR, _______, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_PMNS},
 ...
 */
[_RAISE] = {
  {_______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_DEL, _______, _______, _______, _______, KC_MUTE},
  {_______,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_BSPC, KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_VOLU},
  {_______,  KC_F11,  KC_F12, _______, _______, _______,  KC_ENT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_VOLD},
...
[_ADJUST] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, _______, _______, AU_ON,   AU_OFF,  _______, _______, BEPO,    _______, _______, _______, _______},
