 ...
 * |   Ê  |   À  |   Y  |   X  |   .  |   K  |   '  |   Q  |   G  |   H  |   F  |  Ç   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Enter| Meta |Lower | Alt  |Shift | Space/Ctrl  |AltGr | Raise|   %  |   W  | Bksp |
 * `-----------------------------------------------------------------------------------'
 */
[_BEPO] = {
  ...
  {KC_ENT,  KC_LGUI, LOWER,   KC_LALT, KC_LSFT, CTL_T(KC_SPC),CTL_T(KC_SPC),  BP_ALGR, RAISE,   BP_PERC, BP_W,    KC_BSPC}
},
